...
We are studying the labor force in the United States from 1941 to 2010. The dataset is stored as a comma separated value (CSV) file. Each row holds labor force information for a single year, and the column represent:
